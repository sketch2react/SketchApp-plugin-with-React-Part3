...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/d8ba14f830d2075ef135fc0b3387b25a.html";
...
/*!***************************!*\
  !*** ./src/my-command.js ***!
  \***************************/
/*! exports provided: default, onShutdown, onSelectionChange */
...
var webviewIdentifier = 'my-plugin.webview';
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var webContents = browserWindow.webContents; // Sends initial data to React UI when page has loaded

  webContents.on('did-finish-load', function () {
    var document = sketch__WEBPACK_IMPORTED_MODULE_3___default.a.getSelectedDocument();
    ...
    if (selectedLayers.length > 0) {
      ...
      var name = layer.name;
      sketch_ui__WEBPACK_IMPORTED_MODULE_2___default.a.message(name);
      webContents.executeJavaScript("sendData('".concat(name, "')"))["catch"](console.error);
    }
  ...
  webContents.on('setSelectionName', function (s) {
    //UI.message(s)
    var document = sketch__WEBPACK_IMPORTED_MODULE_3___default.a.getSelectedDocument();
    var selectedLayers = document.selectedLayers; // This also includes artboards
...
function onSelectionChange(context) {
  ...
  if (existingWebview) {
    var webContents = existingWebview.webContents;
    var actionContext = context.actionContext;
    var newSelection = actionContext.newSelection; // This also includes artboards

    if (newSelection.length > 0) {
      // We will only pick the first layer in the selection
      var layer = newSelection[0];
      var wrappedLayer = sketch__WEBPACK_IMPORTED_MODULE_3___default.a.fromNative(layer);
      var name = wrappedLayer.name;
      webContents.executeJavaScript("sendData('".concat(name, "')"))["catch"](console.error);
    }
  }
}
...
globalThis['onSelectionChange'] = __skpm_run.bind(this, 'onSelectionChange')
